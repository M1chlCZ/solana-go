...
func TestMintTo_SetAuthorityAccountDefaultsToSigner(t *testing.T) {
	builder := NewMintToInstructionBuilder()
...
func TestMintTo_ValidateRequiresSigner(t *testing.T) {
	builder := NewMintToInstructionBuilder().
		SetAmount(10).
...
func TestDecodeInstruction_MintTo(t *testing.T) {
	...
	ag_require.NoError(t, err)
	ag_require.IsType(t, &MintTo{}, decoded.Impl)

	got := decoded.Impl.(*MintTo)
